...
for dir in packages/common packages/db packages/agent-sdk packages/mcp packages/registry packages/orchestrator services/api services/indexer packages/agents/*/; do
  dir="${dir%/}"
